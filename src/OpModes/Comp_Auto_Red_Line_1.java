...
public class Competition_Auto_Red_Line_1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // HAD TROUBLE DIALING IN POWER SETTINGS - with volts around 13V down to at least 12.7V had set at 0.52 and 0.20
        // battery ABOVE 13V v left 0.?? and right 0.20
        // battery at 12.65V left 0.?? and right 0.20
        // battery below 12.5V left 0.?? and right 0.20
        // battery at 12.3V left 0.?? and right 2.0
        ...
        double LeftLaunchSpeed = 0.20;
        double RightLaunchSpeed = 0.50;
...
// *****************************************************************************
            ...
            if (position == 2){
                ...
                // Set motor direction and slight pivot left to drive straight down wall towards target Zone
                ...
                // Pivot left to place in target zone
                ...
                // Pivot back right to line up for back up behind line to shoot
                ...
                drive(0, 0, 0, 0);
                sleep(150);
                // Pivot left slightly to shoot rings
...
// *****************************************************************************
                ...
                // Slight pivot left to line up for power shot 1
                frontrightdrive.setDirection(DcMotorSimple.Direction.FORWARD);
                rearrightdrive.setDirection(DcMotorSimple.Direction.FORWARD);
                frontleftdrive.setDirection(DcMotorSimple.Direction.FORWARD);
                rearleftdrive.setDirection(DcMotorSimple.Direction.FORWARD);
                ...
                // Pivot Right slightly to place in target zone
                ...
                // Pivot left slightly line up for navigation
                ...
                // set motors and drive backward to park on line
...
// *****************************************************************************
                ...
                // Set direction & pivot left to shoot
                frontrightdrive.setDirection(DcMotorSimple.Direction.FORWARD);
                rearrightdrive.setDirection(DcMotorSimple.Direction.FORWARD);
                frontleftdrive.setDirection(DcMotorSimple.Direction.FORWARD);
                rearleftdrive.setDirection(DcMotorSimple.Direction.FORWARD);
