...
public class Competition_Auto_Red_Line_2 extends LinearOpMode {
...
// *****************************************************************************
            ...
            if (position == 2){
                ...
                // Pivot left slightly to face straight
                frontrightdrive.setDirection(DcMotorSimple.Direction.FORWARD);
                rearrightdrive.setDirection(DcMotorSimple.Direction.FORWARD);
                frontleftdrive.setDirection(DcMotorSimple.Direction.FORWARD);
                rearleftdrive.setDirection(DcMotorSimple.Direction.FORWARD);
                ...
                // Pivot right to place wobble goal in target zone
...
// *****************************************************************************
                ...
                // originally 457 but hitting rings
                distance(557, 557, 557, 557);
                ...
                // Pivot left to navigate and be out of way of alliance
...
// *****************************************************************************
                ...
                // set motors and forward backward to navigate line and be out of way of alliance robot
